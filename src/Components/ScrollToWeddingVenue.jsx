...
function ScrollToWeddingVenue() {
  ...
  useEffect(() => {
    const targetElement = document.getElementById('venue-section');
  ...
  return (
    <div>
      <button 
        ...
        /* 
          1. Removed the static layout 'animate-fadeIn' from the base string.
          2. We only apply the entry animation class *after* hasTriggered is true.
        */
...
export default ScrollToWeddingVenue;